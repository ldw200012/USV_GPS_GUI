...
```
  > $ensp; rosrun heron_gui main_gui.py -h # (Help command to see available arguments)
  
$ensp;  > rosrun heron_gui main_gui.py -m wp_read # (Read the existing file USV_GPS_GUI/heron_gui/src/csv_files/<filename>.csv)
